...
def main(page:Page):
    ...
    modal=Container(content=Column(controls=[
                Row(controls=[Image(src="uno.jpg")], alignment=MainAxisAlignment.CENTER),
                Row(controls=[Text("Titulo1", size=20)],alignment=MainAxisAlignment.CENTER),
                Row(controls=[Text("srrrsrsrrsrsrsrsrrssr""ssrsrrsrsrsrrssrrsrsrsrsrrs""srsrsrrsrsrrs", width=200, text_align=TextAlign.JUSTIFY)]
                )],
